...
public class RemoteServersManager {
    ...
    private Map<String, Map<String, Map<String, String>>> getServiceVersion(){
        try {
                    ...
                    if(!StringUtils.isEmpty(type)){
                        ...
                        for (String serverType : serverTypes){
                            ...
                            for (String service : serviceVersionsMap.keySet()){
                                //service version层
                                String version = serviceVersionsMap.get(service);
                                //使用最大版本
            ...
            LoggerEx.error(TAG, "Service registry error, errMsg: " + ExceptionUtils.getFullStackTrace(t));
        }
        return null;
    }
