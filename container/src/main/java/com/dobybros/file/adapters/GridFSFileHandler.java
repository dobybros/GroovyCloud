package com.dobybros.file.adapters;
...
//		}
	...
	public static void main(String[] args) throws IOException, DBException {
		...
		helper.setHost("mongodb://database1.ninespirit.cc:7900");
		helper.setDbName("gridfiles");
//		helper.setUsername("dobybrosim");
...
//		helper.setUsername();
		...
		File directory = new File("/home/aplomb/dev/github/PKScripts/deploy");
