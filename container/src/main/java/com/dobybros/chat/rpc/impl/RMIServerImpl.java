...
import com.dobybros.chat.rpc.impl.RMIHandler.RPCEntity;
...
public class RMIServerImpl extends UnicastRemoteObject implements RMIServer {
	...
	public byte[] call(byte[] data, String type, Byte encode)
		...
		if(serverWrapper.rmiHandler == null)
		...
		try {
			...
			entity = serverWrapper.rmiHandler.getRPCEntityForServer(type, adapter.getGroovyClass());
			serverAdapter = adapter.getObject();
