 ...
 */
public final class NioSocketAcceptorEx extends AbstractPollingIoAcceptor<NioSession, ServerSocketChannel>
implements SocketAcceptor {
    ...
    public NioSocketAcceptorEx() {
        super(new SocketSessionConfigEx(), NioProcessor.class);
        ((SocketSessionConfigEx) getSessionConfig()).init(this);
    }
    ...
    public NioSocketAcceptorEx(int processorCount) {
        super(new SocketSessionConfigEx(), NioProcessor.class, processorCount);
        ((SocketSessionConfigEx) getSessionConfig()).init(this);
    }
    ...
    public NioSocketAcceptorEx(IoProcessor<NioSession> processor) {
        super(new SocketSessionConfigEx(), processor);
        ((SocketSessionConfigEx) getSessionConfig()).init(this);
    }
    ...
    public NioSocketAcceptorEx(Executor executor, IoProcessor<NioSession> processor) {
        super(new SocketSessionConfigEx(), executor, processor);
        ((SocketSessionConfigEx) getSessionConfig()).init(this);
    }
     ...
     * {@link SimpleIoProcessorPool}
     */
    public NioSocketAcceptorEx(int processorCount, SelectorProvider selectorProvider) {
        super(new SocketSessionConfigEx(), NioProcessor.class, processorCount, selectorProvider);
        ((SocketSessionConfigEx) getSessionConfig()).init(this);
