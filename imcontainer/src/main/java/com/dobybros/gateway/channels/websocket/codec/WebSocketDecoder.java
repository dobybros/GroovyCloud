 ...
 * @author DHRUV CHOPRA
 */
public abstract class WebSocketDecoder extends CumulativeProtocolDecoder{    
    
	protected abstract void decodeWSPacket(IoSession session, IoBuffer in, ProtocolDecoderOutput out);
    ...
    protected boolean doDecode(IoSession session, IoBuffer in, ProtocolDecoderOutput out) throws Exception {        
        ...
        if(!session.containsAttribute(WebSocketUtils.SessionAttribute)){
            ...
            if(resultBuffer == null){
            	...
            	decodeWSPacket(session, resultBuffer, out);
            	return true;
            }
        } else{
