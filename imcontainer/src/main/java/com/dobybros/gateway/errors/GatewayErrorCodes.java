...
public class GatewayErrorCodes {
	//Error code between -52000 and -50000 will force close tcp channel, but will wait for push every message in tcp channel
	public static final int TCPCHANNEL_CLOSE_START = -50000;
	public static final int ERROR_TCPCHANNEL_MISSING_ONLINEUSER = TCPCHANNEL_CLOSE_START - 1;
	public static final int TCPCHANNEL_CLOSE_END = -50999;

	//Error code between -51999 and -51000 will force close tcp channel and ignore the messages in tcp channel
	public static final int TCPCHANNEL_CLOSE_IMMEDIATELY_START = -51000;
