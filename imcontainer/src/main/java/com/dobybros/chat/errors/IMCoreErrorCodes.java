...
/**
 * code -69999~-60000
 * General common error codes(-60999 ~ -60000), other service has its own error codes, such as
 * AcuComErrorCodes(-63999 ~ -61000), specially, Session error code(-64999 ~ -64000),  WallboardErrorCodes(-65999 ~ -65000),
 * DocsErrorCodes(-66999 ~ -6600), AccountsErrorCodes(--67999 ~ --67000)
 */
public interface IMCoreErrorCodes {

	public static final int CODE_CORE = -60000;//0~999
	public static final int CODE_MEMBERSHIP = -61000;//3000~3999
	public static final int CODE_SESSION = -64000;//4000~4999
