 ...
 * @date 2019/11/15
 */
public class ProxyIMResponse extends RPCResponse {
                ...
                switch(encode) {
                    case ENCODE_JAVABINARY:
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            throw new CoreException(ChatErrorCodes.ERROR_RPC_DECODE_FAILED, "ProxyIMResponse PB parse data failed, " + ExceptionUtils.getFullStackTrace(e));
                        } finally {
                        ...
                        break;
                    default:
                        throw new CoreException(ChatErrorCodes.ERROR_RPC_ENCODER_NOTFOUND, "ProxyIMResponse Encoder type doesn't be found for resurrect");
                }
            }
        }
    }
